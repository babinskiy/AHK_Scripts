...
#F1:: 
    R := R + 1
    SetDefaultEndpoint(DeviceList[Mod(R, DeviceList.Length())+1])

; F1:: SetDefaultEndpoint( GetDeviceID(Devices, "Jabra") )
; F2:: SetDefaultEndpoint( GetDeviceID(Devices, "2- USB") )
; F3:: SetDefaultEndpoint( GetDeviceID(Devices, "Speakers") )

SetDefaultEndpoint(DeviceID)
{
    MsgBox, , Title, %DeviceID%
